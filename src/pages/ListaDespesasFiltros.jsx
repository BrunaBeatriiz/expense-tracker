...
// despesas do mês com filtros de categoria
const ListaDespesasFiltros = ({ despesas, emClickExcluirDespesa }) => {
    ...
    return (
        <main className="bg-gray-50 rounded-lg shadow-lg p-8 w-full max-w-6xl mx-auto">
            ...
            {/* HEADER */}
            <div className="flex items-center justify-between border-b border-[#53720a]/30 mb-6 pb-2 gap-4">
...
export default ListaDespesasFiltros;
